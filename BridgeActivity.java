...
public class BridgeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView) findViewById(R.id.bridge);

        drawable = ContextCompat.getDrawable(this, R.drawable.bridge);
    ...
    public void openshowBridge() {
        Intent intent = new Intent(this, showBridge.class);
